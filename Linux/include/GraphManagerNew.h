...
public:
        ...
        void get_frozen_edge_constraints_with_z3(z3::context &c, z3::solver &s, map<string, z3::expr> &all_z3_var_to_expr_map, GraphNew *graph, set<int> &eids_to_consider, float exp_score_threshold);

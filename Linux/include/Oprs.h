...
/**
 * Added by Sukanya on 15 Feb 2014
 */
inline bool operator<(const bvatom& bv_inst1, const bvatom& bv_inst2)
{
...
class BVManager
{
 ...
 public:
  ...
  bvatom       select_with_int(bvatom bv_inst1, unsigned long hi, unsigned long lo); // hi, lo offsets are taken from the right

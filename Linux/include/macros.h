...
#define NODE_BOUND_BIT_LENGTH(graph) ( (int) ceil(log2 ((double) (graph->get_node_ids().size() + 1))) )
//#define EDGE_BOUND_BIT_LENGTH 12
#define EDGE_BOUND_BIT_LENGTH(graph) ( (int) ceil(log2 ((double) (graph->get_edge_ids().size() + 1))) )
//#define PATH_BOUND_BIT_LENGTH 4//8
#define PATH_BOUND_BIT_LENGTH(path_bound)  ( (int) ceil(log2 ((double) (path_bound+1))) )

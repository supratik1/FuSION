...
//hanjan
    ...
    //nodes_list_iter = nodes_list.begin();
...
//        char wait;
//        cin >> wait;
        //int curr_nid_in_res_graph = nodes_list.front();
...
// cout <<nodes_list.size()<<" ";
/*  if (i == 237) {
        cout <<curr_nid_in_res_graph<<" ";
    }    */  
...
//        // initialize nid_to_outlist_index -- pointing to 0th element
//        vector<int> all_nids = residual_graph->get_node_ids();
//        for (vector<int>::iterator nid = all_nids.begin(); nid != all_nids.end(); nid++) {
//            nid_to_outlist_index.insert(pair<int,int>(*nid, 0)); 
//        }
		...
		if(limit>20)
		   break;
		    ...
		    int edge_cap = residual_graph->get_other_value2_in_edge(*out_itr);
               ...
               // if(curr_nid_in_res_graph == 82)
		//cout<<min_neighbr_height;
			//hanjan		
...
cout<<tgt_node_in_res_graph<<" ";
        ...
        if (curr_height > old_height) {
            ...
            if (element != nodes_list.begin()) {
              ...
              //  cout << "height of " << *nodes_list_iter << " increased to " << curr_height << endl;
 ...
 //   cout << "Node sets" << " s: " << set_s.size() << " t: " << set_t.size() << endl;
    
    for (set<int>::iterator set_s_iter = set_s.begin(); set_s_iter != set_s.end(); set_s_iter++) {

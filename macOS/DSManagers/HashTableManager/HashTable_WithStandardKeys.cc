...
class t_DAGNode;
template class t_HashTable<string,t_DAGNode *>;
template class t_HTStatusValue<t_DAGNode*>;
template class t_HashTable<string,int>;
template class t_HashTable<string, list<string>* >;
template class t_HashTable<string, t_Signal*>;


class t_Expression;
template class t_HashTable<unsigned long int, t_Expression*>;
template class t_HashTable<unsigned long long, t_Expression*>;
//template class t_HashTable<string, t_Expression*>;
template class t_HTStatusValue<t_Expression*>;
template class t_HashTable<string,t_Expression*>;
...
template class t_HashTable<int,pair<t_Expression*, t_Expression*> >;
#ifdef QE //#ifdef added by Ajith John on 24 July 2013
template class t_HashTable<unsigned long long int, pair<bool, set<t_Expression*> > >;
#endif //#ifdef added by Ajith John on 24 July 2013 ends here
#ifdef QE //#ifdef added by Ajith John on 8 Jan 2014
template class t_HashTable<unsigned long int, set<string> >;
#endif //#ifdef added by Ajith John on 8 Jan 2014 ends here
#ifdef QE //#ifdef added by Ajith John on 3 Feb 2014
template class t_HashTable<unsigned long int, int >;
#endif //#ifdef added by Ajith John on 3 Feb 2014 ends here
#ifdef QE //#ifdef added by Ajith John on 11 April 2014
template class t_HashTable<unsigned long int, string >;
#endif //#ifdef added by Ajith John on 11 April 2014 ends here
#ifdef QE //#ifdef added by Ajith John on 17 April 2014
template class t_HashTable<string, set<string> >;
#endif //#ifdef added by Ajith John on 17 April 2014 ends here
